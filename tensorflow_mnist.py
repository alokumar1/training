...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.01,
    ...
    Arguments:
    X_train -- training set, of shape (input size = 784, number of training examples = 55000)
    Y_train -- test set, of shape (output size = 10, number of training examples = 55000)
