...
data = pd.read_csv('five_times_images_data.csv')
...
costs,train_accuracy,tests_accuracy = main_func(names,breed,learning_rate = 0.005,num_epochs = 10,minibatch_size = 30)
