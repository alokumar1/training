...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  5 15:14:18 2018
...
#data = pd.read_csv('/home/alok/spyder/dogbreed/train/labels.csv')
#names = data.id
#dogs = []
#breed = []
#
...
#    img = cv2.imread('/home/alok/spyder/dogbreed/train/'+names[i]+'.jpg')
...
#del data,classes
#pickle.dump(dogs,open('/home/alok/spyder/dogbreed/10222_64_64_images.p','w'))
#pickle.dump(breed,open('/home/alok/spyder/dogbreed/10222_64_64_classes.p','w'))


data = pickle.load(open('/home/alok/spyder/dogbreed/10222_64_64_images.p','rb'))
classes = pickle.load(open('/home/alok/spyder/dogbreed/10222_64_64_classes.p','rb'))
...
y_true = tf.placeholder(tf.float32, shape=[None, 120], name='y_true_placeholder')
...
layer_fc2 = new_fc_layer(input=layer_relu3, num_inputs=128, num_outputs=120, name="fc2")
