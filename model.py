...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  3 10:49:43 2018
...
train_x,test_x,train_y,test_y=train_test_split(data,classes,test_size = 0.20,random_state=42)  
...
layer_conv3, weights_conv3 = new_conv_layer(input=layer_pool2, num_input_channels=16, filter_size=5, num_filters=32, name= "conv3")
layer_relu3 = new_relu_layer(layer_conv3, name="relu3")
layer_pool3 = new_pool_layer(layer_relu3, name="pool3")
layer_norm = tf.contrib.layers.batch_norm(layer_pool3)


# Flatten Layer
num_features = layer_norm.get_shape()[1:4].num_elements()
layer_flat = tf.reshape(layer_norm, [-1, num_features])
...
layer_fc2 = new_fc_layer(input=layer_relu4, num_inputs=128, num_outputs=12, name="fc2")
